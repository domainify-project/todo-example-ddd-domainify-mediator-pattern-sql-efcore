...
namespace FluentAssertions
{
    ...
    {
        /// <summary>
        /// Asserts that the asynchronous function throws an ErrorException containing a fault of the specified type.
        /// </summary>
        /// <typeparam name="TFault">The type of the fault to check for in the ErrorException.</typeparam>
        ...
        /// throws an ErrorException containing a fault of the specified type.
        /// </remarks>
